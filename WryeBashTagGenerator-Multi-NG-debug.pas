...
Const 
  ScriptName    = 'WryeBashTagGenerator-Multi-NG-debug';
  ScriptVersion = '1.9.2.1-multi-debug';
...
Begin
  ...
  g_AddTags  := False;
  g_AddFile  := False;
  // Multi defaults: keep log size down; use debug filters instead of dumping everything.
  g_LogTests             := False;
