{
  ...
  This file is a fork of WryeBashTagGenerator-NG.pas (base SHA: 0b20d04,
  synced with the 1.9.2.1 cleanup/deduplication/fix pass).
...
// TODO: speed this up!
// A flag-array edit value is a string of '0'/'1' characters (one per flag).
// "Empty" means no flag bits are set — equivalently, no '1' appears anywhere.
Function IsEmptyKey(AEditValues: String): boolean;
Begin
  Result := Pos('1', AEditValues) = 0;
End;
